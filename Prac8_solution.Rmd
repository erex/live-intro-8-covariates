...
```{r estfigs, fig.cap="Density estimates for amakihi data set under a variety of detection function models and truncation distances.", echo=FALSE, fig.width=9, fig.height= 10}
