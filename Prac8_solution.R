...
plot(amak.hr.obs.mas, showpoints=FALSE, main="Amakihi Observer and Minutes")
...
add_df_covar_line(amak.hr.obs.mas, data=sfzero, lty=1, lwd=2,col="blue")
add_df_covar_line(amak.hr.obs.mas, data=sf180, lty=2, lwd=2,col="blue")
add_df_covar_line(amak.hr.obs.mas, data=t1zero, lty=1,lwd=2,col="red")
add_df_covar_line(amak.hr.obs.mas, data=t1180, lty=2, lwd=2,col="red")
add_df_covar_line(amak.hr.obs.mas, data=t2zero, lty=1,lwd=2,col="green")
add_df_covar_line(amak.hr.obs.mas, data=t2180, lty=2, lwd=2,col="green")
...
plot(Savannah_sparrow_1981.hn.region, showpoints=FALSE, 
     main="Savannah sparrows with pasture covariate")
k <- 1
for (i in pastures) {
  k <- k+1
...
addtable2plot(31, 0.83, parms, bty="o",
