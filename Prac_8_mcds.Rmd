...
This exercise consists of three data sets of increasing difficulty.  The first problem, MCDS with point transects, is  complicated and (using the functionality available in `R`) also includes some basic exploratory analysis of the covariates. Problems 2 and 3 are optional but will take you deeper into the heart of understanding multiple covariates. 
